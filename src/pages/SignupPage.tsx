      ...
      <div className="relative z-10 flex min-h-0 flex-1 items-center justify-center overflow-hidden p-4">
        <div className="w-full max-w-[26.6rem] rounded-2xl border border-slate-200/80 bg-white px-7 py-6 shadow-xl shadow-slate-900/10">
          <div className="text-center">
            ...
            <h1 className="text-[22px] font-bold tracking-tight text-slate-800">Create your account</h1>
          ...
          {googleBusy ? (
            ...
            <div className="mt-3.5 space-y-3">
              ...
              {step === "name" ? (
                <input
                  autoFocus
                  className="h-12 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm text-slate-800 outline-none focus:border-neutral-900 focus:ring-1 focus:ring-yellow-500"
              ...
              {step === "mobile" ? (
                <PhoneInput
                  ...
                  inputClass="!w-full !h-12 !rounded-lg !text-sm"
                  containerClass="!w-full"
                  buttonClass="!rounded-l-lg !h-12"
                />
              ) : null}
              ...
              {step === "telegram" ? (
                <div className="relative">
                  ...
                  <input
                    autoFocus
                    className="h-12 w-full rounded-lg border border-slate-200 bg-white py-2 pl-7 pr-3 text-sm text-slate-800 outline-none focus:border-neutral-900 focus:ring-1 focus:ring-yellow-500"
              ...
              {step === "otp" ? (
                <div className="space-y-2">
                  <input
                    ...
                    className="h-12 w-full rounded-lg border border-slate-200 bg-white px-3 text-center font-mono text-base tracking-[0.35em] text-slate-800 outline-none focus:border-neutral-900 focus:ring-1 focus:ring-yellow-500"
                    placeholder="••••••"
                    maxLength={6}
                    value={otp}
